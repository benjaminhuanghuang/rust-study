/*
DTOs (Data Transfer Objects) are objects used to transfer data between different layers or parts of an application,
typically between the backend and frontend or between services in a distributed system.
*/
